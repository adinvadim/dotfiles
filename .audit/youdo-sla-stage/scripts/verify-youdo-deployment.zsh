...
required_artifacts='["cli","scripts/build-youdo-daily-report-input.zsh","scripts/capture-youdo-offer-position.zsh","scripts/finalize-youdo-sbr-offer.zsh","scripts/finish-youdo-monitor-run.zsh","scripts/reconcile-youdo-ambiguous.zsh","scripts/record-youdo-crm-transition.zsh","scripts/record-youdo-outcome.zsh","scripts/record-youdo-stage-timing.zsh","scripts/requeue-youdo-covered-payment-blocked.zsh","scripts/run-protected-youdo-offer.zsh","scripts/run-youdo-auto-offer-if-new.zsh","scripts/run-youdo-daily-report.zsh","scripts/scan-youdo-inbox.zsh","scripts/scan-youdo-new-tasks.zsh","scripts/sync-youdo-crm.zsh","scripts/verify-youdo-deployment.zsh","scripts/write-youdo-daily-report.zsh","scripts/youdo-crm.zsh","scripts/youdo-exec.zsh","scripts/youdo-sla-monitor.zsh","skills/youdo-auto-offer/SKILL.md","skills/youdo-daily-report/SKILL.md","skills/youdo-opportunity-scout/SKILL.md","state/auto-offer-policy.json"]'
